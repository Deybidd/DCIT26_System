	...
	return (
		...
		>
			<g fill="none" stroke="#000" strokeWidth={1.5}>
				<path d="M7.5 3.5c-1.556.047-2.323.22-3.125.862c-.879.88-.879 2.295-.879 5.126v6.506c0 2.832 0 4.247.879 5.127C5.253 22 6.668 22 9.496 22h5c2.829 0 4.243 0 5.121-.88c.88-.879.88-2.294.88-5.126V9.328c0-2.83 0-4.246-.88-5.126c-.641-.642-1.569-.815-3.125-.862"></path>
				<path
